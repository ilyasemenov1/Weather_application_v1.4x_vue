	...
	<form class="dark-mode-form">
		...
		<div class="dark-mode-form__theme-select" @click="updateSetingsOnClick">
			<div class="dark-mode-form__select-container">
				<input
					type="radio"
					id="night-mode-active"
					class="dark-mode-form__button-input"
					name="dark-mode"
					value="active"
					v-model="selectMode"
					tabindex="0"
		...
		<div
			class="marker"
			:style="{ width: `${markerWidth}px`, transform: `translateX(${markerLeft}px)` }"
		></div>
	</form>
</template>
